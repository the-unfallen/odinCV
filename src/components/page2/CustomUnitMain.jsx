...
import '../../styles/page2/CustomUnitMain.css'


 const CustomUnitMain = ({
    submitCustomDetails,
    item_ref,
    MainEditStateToggle,
    item_state,
    ...
    if (item_state && modified) {
        return (
            <div className='sectionContainer'>
                {!customNameEditState && (
                    <div>
                        <div className="p2SectionTitle">{customUnitName}</div>
                        <div className="p2CustomTitleSubmit">
                            <Button children={'Edit'} onClick={() => ToggleCustomNameEditState(item_ref)}/>
                        </div>
                    </div>
                )}
                {customNameEditState && (
    ...
    if (item_state && !modified) {
        ...
        return (
            <div className='sectionContainer'>
                <div className="p2SectionTitle">New Section Details</div>
                <div>
                    <label>
                        Custom Section Title:
            ...
            {valuesBlock.length > 0 &&
                valuesBlock.map((this_value) => {
                    return this_value.state ? (
                        <div key={this_value.id} className="p2CustomValuesEdit">
                            <div>
                                <textarea
                                    value={this_value.text}
                                    onChange={textValueChange}
                        ...
                        <div key={this_value.id} className='p2MiniSkillDiv'>
