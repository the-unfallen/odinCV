    ...
    if(!editState){
        return(
            <div className='sectionContainer'>
                <div className='p2SectionTitle'>Professional Skills</div>
                <div >
                ...
                <div >
                    ...
                    { miniEditState === null && (
                        <div className='p2AddMiniSkill'>
                            <div><input type="text" onChange={handleChange} ref={inputRef}/><Button  children={<Icon path={mdiPlusCircleOutline} size={1} />} onClick={addNewSkill}/></div>
...
export default Page2ProfessionalSkills