...
import "../styles/CustomUnitR.css";
import { mdiSquareEditOutline } from '@mdi/js';
// import { mdiArrowLeft } from '@mdi/js';
import { mdiCheckOutline } from '@mdi/js';

export default function CustomUnitR({
    submitCustomDetails,
    item_ref,
    MainEditStateToggle,
    item_state,
    ...
    if (item_state && modified) {
        return (
            <div className="customEditingR">
                {!customNameEditState && (
                    <div className="customEditTitle">
                        <div className="customUnitNameR">{customUnitName}</div>
    ...
    if (item_state && !modified) {
        ...
        return (
            <div className="customAddNewSectionR">
                <div className="new-section-header">New Section Details</div>
                <div className="customNewTitleBoxR">
                    <label>
                        Custom Section Title:
